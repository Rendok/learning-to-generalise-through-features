...
class KukaMultiBlocksEnv(KukaGymEnv):
    ...
    def _reward_move_pick(self):
        ...
        if self._attempted_grasp:
            ...
            if z > 0.1:
                #print("Z + 50:", z)
                return 50.0 - 100/7 * block_norm
            return -1.0
        else:
            return - 10*self.distance_x_y - 10*abs(self.distance_z - 0.0345) - action_norm - 100/7 * block_norm
    ...
    def _reward_place(self):
        ...
        return -10*self.distance_x_y - 10*abs(self.distance_z - 0.0075) - action_norm #- 100/9 * block_norm
